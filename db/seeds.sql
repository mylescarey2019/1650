...
INSERT INTO plan_type (type_name) VALUES ('demo');
INSERT INTO plan_type (type_name) VALUES ('guest');
INSERT INTO plan_type (type_name) VALUES ('user');


INSERT INTO plan_user (user_name) VALUES ('system');
INSERT INTO plan_user (user_name) VALUES ('guest');
...
INSERT INTO life_chapter (seq_no,chapter_name,start_age,end_age,invest_amount,invest_rate_type_id,return_pct,inflation_pct,plan_id)
     VALUES (1,'High School',16,18,10.00,1,10.0,3.0,1),
            (2,'College',19,22,100.00,1,8.0,3.0,1),
            (3,'Early Adult',23,35,100.00,1,9.0,3.2,1),
            (4,'Mid Adult',36,55,200.00,1,8.0,3.4,1), 
            (5,'Later Adult',56,65,120.00,1,7.0,4.0,1);

INSERT INTO life_chapter (seq_no,chapter_name,start_age,end_age,invest_amount,invest_rate_type_id,return_pct,inflation_pct,plan_id)
     VALUES (1,'High School',16,18,20.00,1,10.0,3.0,2),
            (2,'College',19,22,30.00,1,10.5,3.0,2),
            (3,'Adult',23,65,5000.00,1,7.0,4.0,2);

INSERT INTO life_chapter (seq_no,chapter_name,start_age,end_age,invest_amount,invest_rate_type_id,return_pct,inflation_pct,plan_id)
     VALUES (1,'School Years',16,24,10.00,1,8.0,3.0,3),
            (2,'Adult',24,60,75.00,1,7.0,3.0,3),
            (3,'Early Retirement',61,65, 1000.00,1,6.0,4.5,3);
